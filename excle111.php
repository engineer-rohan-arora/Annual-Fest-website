 <?php
        ...
        $subEvent = $_SESSION['subEvent1'];
        $gender = $_SESSION['gender1'];
        

        $sql = "select * from $name where Event = '$subEvent' and gender = '$gender'";
    ...
    //output each row of the data, format line as csv and write to file pointer
        ...
        $lineData = array($row['Name'], $row['CollageName'], $row['Course'], $row['Branch'], $row['Year'], $row['Mobile'],$row['Email'],$row['Event'],$row['Address'],$row['gender'],$row['UID']);
